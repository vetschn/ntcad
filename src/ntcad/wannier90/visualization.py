...
def plot_operator(
    ...
    **kwargs: dict
    ...
    # The extent keyword here is used to set the ticks correctly and to
    # compensate for the fact that `ax.matshow` plots the pixels *on top
    # of* the index / coordinate.
    ax.matshow(O, norm=LogNorm(), extent=(0, O_.shape[0], O_.shape[1], 0), **kwargs)
